...
public class WindowUtils
{
     ...
     */
    private static ArrayList<String> adaptWinFilePathes(JSONObject config, ArrayList<String> winfiles) {
    ...
    public static ArrayList<double[]> loadWindows(JSONObject cur_stream, JSONObject config) throws FileNotFoundException, IOException{
        ...
        winfiles = adaptWinFilePathes(config, winfiles);
        ArrayList<double[]> windows = new ArrayList<double[]>();
        for (String win_filename: winfiles) {
